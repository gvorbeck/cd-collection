/* ============================================================
   ...
   ------------------------------------------------------------
   Run with:  node scripts/bandcamp-wishlist/build.mjs

   Two files here hold the same program: bandcamp-wishlist.js is the
   one a person reads and edits, and bandcamp-wishlist.bookmarklet.txt
...
const src = readFileSync(join(here, 'bandcamp-wishlist.js'), 'utf8');
const out = join(here, 'bandcamp-wishlist.bookmarklet.txt');
